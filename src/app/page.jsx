      ...
      <main className="w-full max-w-lg lg:max-w-5xl xl:max-w-6xl mx-auto my-auto py-2 sm:py-4">
        ...
        {isGoogleModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-xs animate-in fade-in duration-200">
            <div className="w-full max-w-md bg-white rounded-3xl p-6 sm:p-8 shadow-2xl border border-[#cdf2cb] space-y-5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-base font-extrabold text-[#032109]">Google Account Setup</h3>
                    <p className="text-xs text-gray-500">Sign up or connect your account</p>
                  </div>
                </div>
                <button
                  type="button"
              ...
              <form onSubmit={handleCustomGoogleSubmit} className="space-y-4">
                ...
                <div className="pt-2 flex gap-3">
                  <button
                    type="button"
                    onClick={() => setIsGoogleModalOpen(false)}
                    className="flex-1 py-2.5 rounded-xl border border-gray-300 font-bold text-xs sm:text-sm text-gray-700 hover:bg-gray-50 cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={isSubmittingGoogleModal}
                    className="flex-1 py-2.5 rounded-xl bg-[#006e1c] hover:bg-[#0d631b] font-bold text-xs sm:text-sm text-white shadow-md cursor-pointer flex items-center justify-center gap-1.5"
                  >
                    <span>{isSubmittingGoogleModal ? 'Connecting...' : 'Continue to Step 3 →'}</span>
                  </button>
                </div>
              </form>
            </div>
